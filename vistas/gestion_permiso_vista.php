...
Case pu.visualizar when 0 then 'Inactivo' 
             when 1 then 'Activo'
END   as visualizar    from tbl_permisos pu,tbl_roles r,tbl_objetos p where pu.id_rol=r.id_rol and pu.id_objeto=p.id_objeto;";
$resultadotabla_permisos = $conection->query($sqltabla_permisos);
        }
...
if ($visualizacion==0)
 ...
 echo '<script type="text/javascript">
                           ...
                           window.location = "../vistas/menu_permisos_vista.php";
...

{
        ...
        bitacora::evento_bitacora( $_SESSION['idUser'],$Id_objeto,'Ingreso' , 'A Gestion de permisos usuarios');
...
//$Id_pantalla = $_GET['Id_pantalla'];  
 ...
 $_SESSION['Id_permiso_usuario_gestion']= $row['id_permiso']; 
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
         ...
         <h1>GESTION PERMISOS USUARIOS</h1>
          </div>

                <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="../vistas/principal_vista.php">INICIO</a></li>
              <li class="breadcrumb-item active"><a href="../vistas/crear_permiso_vista.php">CREAR PERMISO</a></li>
            </ol>
          </div>
          ...
          <td><?php echo $row['modificar']; ?></td>
            <td><?php echo $row['eliminar']; ?></td>
                  ...
                  <td style="text-align: center;">
                       ...
                       <a href="../vistas/gestion_permiso_vista.php?rol=<?php echo $row['rol']; ?>&pantalla=<?php echo $row['objeto']?>" class="btn btn-primary btn-raised btn-xs">
...
<form action="../controlador/actualizar_permisos_usuarios_controlador.php?Id_permisos_usuarios=<?php echo $_SESSION['Id_permiso_usuario_gestion']; ?>" method="post" data-form="update" autocomplete="off" >
