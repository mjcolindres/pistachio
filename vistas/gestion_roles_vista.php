...
END   as estado            
FROM tbl_roles";
$resultadotabla = $conection->query($sqltabla);
...

{
        ...
        bitacora::evento_bitacora( $_SESSION['idUser'],$Id_objeto,'Ingreso' , 'A Gestion de Roles');
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../vistas/crear_rol_vista.php">NUEVO ROL</a></li>
      ...
      <a href="../vistas/crear_rol_vista.php" 
      class="btn btn-primary"><i class="fas fa-plus"></i> NUEVO ROL</a>
              ...
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <label>Modificar Rol</label>
                        ...
                        <input  class="form-control" type="text" id="txtnombrerol" name="txtnombrerol"  value="<?php echo $_SESSION['Rol_gestion'];?>" required style="text-transform: uppercase" onkeyup="Espacio(this, event)"  onkeypress="return Letras(event)" maxlength="30" onpaste="return false">
               ...
               <div class="form-group">
                        ...
                        <input  class="form-control" type="text" id="txtdescripcionrol" name="txtdescripcionrol" value="<?php echo $_SESSION['DescripcionRol_gestion'];?>" required style="text-transform: uppercase"  onkeypress="return Letras(event)" onkeyup="DobleEspacio(this, event)" onpaste="return false" maxlength="30" onkeypress="return comprobar(this.value, event, this.id)">
