...
{
        bitacora::evento_bitacora( $_SESSION['idUser'],$Id_objeto,'Ingreso' , 'A Permisos a roles y pantallas');
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../vistas/gestion_permiso_vista.php">GESTIÓN DE PERMISOS</a></li>
...
<form action="../controlador/guardar_permisos_usuario_controlador.php" method="post"  data-form="save" autocomplete="off" class="FormularioAjax">
