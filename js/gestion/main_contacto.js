$(document).ready(function() {
    ...
    tablaContactoEmpresa = $('#tablaContactoEmpresa').DataTable({  
        "ajax":{            
            "url": "../Modelos/listar_empresas_contacto_modelo.php", 
            "method": 'POST', //usamos el metodo POST
            "data":{opcion:opcion}, //enviamos opcion 4 para que haga un SELECT
            "dataSrc":""
        },
        "columns":[
            {"data": "id_contacto_empresa"},
            {"data": "nombre_contacto"},            
            {"defaultContent": "<div class='text-center'><div class='btn-group'><button class='btn btn-primary btn-sm btnEditar'><i class='material-icons'>Datos personales</i></button><button class='btn btn-danger btn-sm btnBorrar'><i class='material-icons'>delete</i></button></div></div>"}
        ],
