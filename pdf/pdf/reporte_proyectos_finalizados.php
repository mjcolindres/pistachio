...
function Header()
{
    ...
    $this->Ln(20);
    $this->SetFont('Arial','B',15);
    $this->cell(0,6,utf8_decode('Listado de Proyectos Finalizados de Vinculación'),0,0,'C',0);
    $this->Ln(15);
...
$consulta2 = "SELECT id_estado FROM tbl_mgp_estado WHERE descripcion='FINALIZADO'";
