...
END   as estado           
FROM tbl_preguntas";
$resultadotabla_pregunta = $conection->query($sqltabla_pregunta);
...
if ($visualizacion==0)
 {
    echo '<script type="text/javascript">
                           ...
                           window.location = "../vistas/menu_pregunta_seguridad_vista.php";
...

{
        ...
        bitacora::evento_bitacora( $_SESSION['idUser'],$Id_objeto,'Ingreso' , 'A Gestion de Preguntas');
...
<body >
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../vistas/crear_pregunta_nueva_vista.php">NUEVA PREGUNTA</a></li>
      ...
      <a href="../vistas/crear_pregunta_nueva_vista.php" 
      class="btn btn-primary"><i class="fas fa-plus"></i> NUEVA PREGUNTA</a>
    </section>
...
<form action="../controlador/actualizar_pregunta_controlador.php?Id_pregunta=<?php echo $Id_pregunta; ?>" method="post"  data-form="update" autocomplete="off" >
 ...
 <input class="form-control" type="text" id="txt_pregunta_modificar" name="txt_pregunta_modificar" style="text-transform: uppercase" onkeypress="return Letras(event)" onkeyup="DobleEspacio(this, event)" onpaste="return false" required="" maxlength="30" value="<?php echo $_SESSION['TxtPregunta'];?>">
