...
function myFunction1(){                    
    ...
    /*=============================================
    =    VALIDAION QUE NO PERMITA  ESPACIO AL INICIO         =
    =============================================*/
    
    
    function validare(){
      txt_estado = document.getElementById("txt_estado").value;
      console.log(txt_estado.trim());

      if (/^\s+$/.test(txt_estado)){
     
          swal("ERROR", "¡NO SE PERMITE DEJAR ESPACIOS AL INICIO DEL CAMPO!", "error");
    ...
    function validart(){
      txt_tipanexo = document.getElementById("txt_tipanexo").value;
      console.log(txt_tipanexo.trim());

      if (/^\s+$/.test(txt_tipanexo)){
    ...
    function validarc(){
      txt_clasificacion = document.getElementById("txt_clasificacion").value;
      console.log(txt_clasificacion.trim());

      if (/^\s+$/.test(txt_clasificacion)){
    ...
    function validartc(){
      txt_tipcontacto = document.getElementById("txt_tipcontacto").value;
      console.log(txt_tipcontacto.trim());

      if (/^\s+$/.test(txt_tipcontacto)){
    ...
    function validarr(){
      txt_region = document.getElementById("txt_region").value;
      console.log(txt_region.trim());

      if (/^\s+$/.test(txt_region)){
