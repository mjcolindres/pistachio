...
header("location: ../contenidos/gestionPermisos-view.php?msj=1 ");*/
	...
	if($resultado === TRUE){
		        bitacora::evento_bitacora( $_SESSION['idUser'],$Id_objeto,'MODIFICO' , 'EL INSERTAR A'.$checkInsertar1.',EL MODIFICAR A'.$checkModificar1.' ,EL ELIMINAR A'.$checkEliminar1.' ,EL VISUALIZAR A'.$checkVer1.' ');

		header("location: ../vistas/gestion_permiso_vista.php?msj=1 ");

}
else
{
	
	header("location: ../vistas/gestion_permiso_vista.php?msj=2 ");
